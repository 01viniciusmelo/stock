...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<!--<form action="index.html" id="login-form" class="smart-form client-form">-->
								<?php echo form_open( site_url('auth/login'), ['class' => 'smart-form client-form'] ); ?>
								<header>
									Sign In
								</header>
								...
								<fieldset>
									...
									<section>
										...
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="email" name="login_string" id="login_string" autocomplete="off" maxlength="255" />
		...
		?> autocomplete="off" readonly="readonly" onfocus="this.removeAttribute('readonly');" />
										...
										<div class="note">
											<a href="<?php echo site_url('auth/recover'); ?>">Forgot password?</a>
										</div>
									</section>
