...
<html lang="en-us" id="extr-page">
	<head>
		<meta charset="utf-8">
		<title> <?php echo config_item('stock_site_name');?></title>
		<meta name="description" content="stock system">
		<meta name="author" content="cheewaphat l.">
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo asset_url('css/your_style.css');?>"> -->

		<!-- Demo purpose only: goes with demo.js, you can delete this css when designing your own WebApp -->
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo asset_url('css/demo.min.css');?>">
	...
	<body class="animated fadeInDown">
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big"><?php echo config_item('stock_site_name');?></h1>
						
					</div>

					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
								<?php echo form_open( site_url("auth/forgot_password"), ['class' => 'smart-form client-form',"id"=>"login-form"] ); ?>
								<header>
								...
								<fieldset>
									...
									<?php endif?>
									<section>
										<label class="label"> <?php echo (($type=='email') ? sprintf(lang('forgot_password_email_label'), $identity_label) : sprintf(lang('forgot_password_identity_label'), $identity_label));?></label>
		...
		<script src="<?php echo asset_url('js/plugin/pace/pace.min.js');?>"></script>

	    <!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
	    <script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
		<script> if (!window.jQuery) { document.write('<script src="<?php echo asset_url('js/libs/jquery-2.1.1.min.js');?>"><\/script>');} </script>

	    <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
		<script> if (!window.jQuery.ui) { document.write('<script src="<?php echo asset_url('js/libs/jquery-ui-1.10.3.min.js');?>"><\/script>');} </script>
