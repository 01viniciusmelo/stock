				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
								<?php echo form_open( site_url("auth/login"), ['class' => 'smart-form client-form',"id"=>"login-form"] ); ?>
								<header>
									Sign In
								</header>
								...
								<fieldset>
									...
									<?php endif?>
									<section>
										<label class="label"> <?php echo lang('login_identity_label', 'identity');?></label>
									...
									<section>
										<label class="label"><?php echo lang('login_password_label', 'password');?></label>
									...
									<?php if( config_item('remember_users') ):?>
									<section>
